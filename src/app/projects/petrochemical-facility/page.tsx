              ...
              <motion.a
                className={`text-sm font-medium ${
                  index === items.length - 1
                    ? 'text-purple-400 cursor-default' // Changed color for Petrochemical
...
// --- PetrochemicalFacilityProjectShowcase Component ---
export default function PetrochemicalFacilityPage() {
  ...
  // Sample project images for petrochemical facility
  const projectImages = [
    'https://plus.unsplash.com/premium_photo-1682144333631-eac578433ea1?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Example petrochemical image 1
    'https://images.unsplash.com/photo-1648555394313-494797ad48fc?q=80&w=1970&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Example petrochemical image 2
    'https://plus.unsplash.com/premium_photo-1677648974967-3ccd71cfadeb?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Example petrochemical image 3
    'https://plus.unsplash.com/premium_photo-1663045542244-5a7b64e37ef5?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'  // Reused general industrial
  ];
  ...
  const glowClasses = mounted && isDarkMode
    ? 'shadow-[0_0_30px_rgba(128,0,128,0.3),_0_0_60px_rgba(148,0,211,0.2)]' // Purple/Indigo glow for petrochemical
    : 'shadow-[0_0_20px_rgba(128,0,128,0.1),_0_0_40px_rgba(148,0,211,0.08)]';

  const titleGradient = mounted && isDarkMode
    ? 'from-purple-400 via-indigo-500 to-violet-600' // Dark mode purple/indigo
    : 'from-purple-600 via-indigo-700 to-violet-800'; // Light mode purple/indigo
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className={`absolute -bottom-40 -left-40 w-96 h-96 rounded-full ${
            mounted && isDarkMode ? 'bg-gradient-to-br from-violet-500/10 to-pink-500/5' : 'bg-gradient-to-br from-violet-500/5 to-pink-500/3'
          } blur-3xl`}
        />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-6 py-12 pt-28">
        ...
        >
          <Breadcrumb items={[
            ...
            { label: 'Vadodara Petrochemical Facility', href: '/projects/petrochemical-facility' },
          ]} />
        </motion.div>
        ...
        >
          ...
          >
            A cutting-edge petrochemical facility for Petro Industries, focused on advanced production and environmental safety.
          </motion.p>
        </motion.header>
            ...
            <div className="relative h-96 md:h-[500px] rounded-2xl overflow-hidden">
              <AnimatePresence initial={false} mode="wait">
                <motion.img
                  ...
                  alt={`Petrochemical Facility Project ${currentImage + 1}`}
        ...
        >
          <div className="grid md:grid-cols-2 gap-8">
            <motion.div
              ...
              whileHover={{ scale: 1.01, boxShadow: mounted && isDarkMode ? "0 0 40px rgba(128,0,128,0.4)" : "0 0 30px rgba(128,0,128,0.2)" }}
            >
              ...
              <div className="space-y-4">
                ...
                <div className={`flex items-center space-x-3 ${mounted && isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>
                  ...
                  <span className="text-lg">Petro Industries</span>
                </div>
                <p className={`text-lg leading-relaxed ${mounted && isDarkMode ? 'opacity-80' : 'opacity-90'}`}>
                  Construction of a new **petrochemical manufacturing facility** spanning over **75 acres**,
                  designed for the production of advanced polymers and specialty chemicals.
                  The project incorporates **cutting-edge safety protocols** and **waste treatment technologies**
                  to ensure minimal environmental impact and maximize operational efficiency.
                </p>
              </div>
            </motion.div>
            ...
            <motion.div
              className={`p-8 rounded-3xl border transition-all duration-300 ${cardClasses} ${glowClasses}`}
              whileHover={{ scale: 1.01, boxShadow: mounted && isDarkMode ? "0 0 40px rgba(148,0,211,0.4)" : "0 0 30px rgba(148,0,211,0.2)" }}
            >
              ...
              <div className="grid grid-cols-2 gap-6">
                <motion.div className="text-center" initial={{ scale: 0.8 }} animate={{ scale: 1 }} transition={{ delay: 0.9, type: "spring" }}>
                  ...
                  <div className={`text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r ${mounted && isDarkMode ? 'from-purple-300 to-indigo-400' : 'from-purple-600 to-indigo-700'}`}>75</div>
                ...
                <motion.div className="text-center" initial={{ scale: 0.8 }} animate={{ scale: 1 }} transition={{ delay: 1.0, type: "spring" }}>
                  ...
                  <div className={`text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r ${mounted && isDarkMode ? 'from-violet-300 to-pink-400' : 'from-violet-600 to-pink-700'}`}>24</div>
                ...
                <motion.div className="text-center" initial={{ scale: 0.8 }} animate={{ scale: 1 }} transition={{ delay: 1.1, type: "spring" }}>
                  ...
                  <div className={`text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r ${mounted && isDarkMode ? 'from-slate-300 to-gray-400' : 'from-slate-600 to-gray-700'}`}>350+</div>
                  <div className={`text-sm ${mounted && isDarkMode ? 'opacity-70' : 'opacity-80'}`}>Workers</div>
                </motion.div>
                <motion.div className="text-center" initial={{ scale: 0.8 }} animate={{ scale: 1 }} transition={{ delay: 1.2, type: "spring" }}>
                  ...
                  <div className={`text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r ${mounted && isDarkMode ? 'from-green-300 to-lime-400' : 'from-green-600 to-lime-700'}`}>10K+</div>
                  <div className={`text-sm ${mounted && isDarkMode ? 'opacity-70' : 'opacity-80'}`}>Tonnes Annually</div>
                </motion.div>
              </div>
            </motion.div>
          </div>
        ...
        >
          <div className={`p-8 rounded-3xl border transition-all duration-300 ${cardClasses} ${glowClasses}`}>
            ...
            <div className="relative h-96 rounded-2xl overflow-hidden">
              <img
                src="https://images.unsplash.com/photo-1651769005074-2ef5c6f74276?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" // Placeholder for "Before"
              ...
              />
              <img
                src="https://plus.unsplash.com/premium_photo-1677648974967-3ccd71cfadeb?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" // Placeholder for "After" (using one of the new images)
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <input
                  ...
                  className="w-full md:w-3/4 h-2 bg-gradient-to-r from-gray-500 to-purple-500 rounded-lg appearance-none cursor-pointer absolute z-10"
                  style={{
                    background: `linear-gradient(to right, #6b7280 0%, #6b7280 ${beforeAfter}%, #8a2be2 ${beforeAfter}%, #8a2be2 100%)` // Adjusted colors
                  }}
                />
        ...
        >
          <div className={`p-8 rounded-3xl text-center border transition-all duration-300 ${cardClasses} ${glowClasses}`}>
            <div className="mb-6">
              <motion.div
                className="w-16 h-16 mx-auto rounded-full bg-gradient-to-r from-purple-400 to-indigo-500 flex items-center justify-center mb-4 text-white"
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
              ...
              <h4 className={`text-xl font-semibold ${mounted && isDarkMode ? 'text-white' : 'text-gray-900'}`}>Siddharth Patel</h4>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className={`text-lg mb-8 max-w-2xl mx-auto ${mounted && isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>
              Explore more of our impactful projects or delve deeper into our specialized services.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
              <Link href="/projects/chemical-plant-expansion" passHref legacyBehavior>
                <Button className={`w-full py-3 px-6 rounded-xl text-lg font-semibold transition-all duration-300 transform ${mounted && isDarkMode ? 'bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white shadow-lg' : 'bg-gradient-to-r from-indigo-500 to-blue-500 hover:from-indigo-600 hover:to-blue-600 text-white shadow-lg'}`}
                  asChild
                >
                  <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}><FlaskConical className="mr-2" /> View Our Chemical Plant Expansion</motion.a>
                </Button>
              </Link>
              <Link href="/projects/oil-gas-refinery" passHref legacyBehavior>
                <Button className={`w-full py-3 px-6 rounded-xl text-lg font-semibold transition-all duration-300 transform ${mounted && isDarkMode ? 'bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white shadow-lg' : 'bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white shadow-lg'}`}
                  asChild
                >
                  <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}><Zap className="mr-2" /> Explore Our Oil & Gas Refinery Project</motion.a>
                </Button>
              </Link>
              <Link href="/services/epc-petrochemical" passHref legacyBehavior>
                <Button className={`w-full py-3 px-6 rounded-xl text-lg font-semibold transition-all duration-300 transform ${mounted && isDarkMode ? 'bg-gradient-to-r from-gray-600 to-purple-600 hover:from-gray-700 hover:to-purple-700 text-white shadow-lg' : 'bg-gradient-to-r from-gray-500 to-purple-500 hover:from-gray-600 hover:to-purple-600 text-white shadow-lg'}`}
                  asChild
                >
                  <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}><Briefcase className="mr-2" /> Learn About Our Petrochemical EPC Services</motion.a>
                </Button>
              </Link>
              <Link href="/contact" passHref legacyBehavior>
                <Button className={`w-full py-3 px-6 rounded-xl text-lg font-semibold transition-all duration-300 transform ${mounted && isDarkMode ? 'bg-gradient-to-r from-teal-600 to-green-600 hover:from-teal-700 hover:to-green-700 text-white shadow-lg' : 'bg-gradient-to-r from-teal-500 to-green-500 hover:from-teal-600 hover:to-green-600 text-white shadow-lg'}`}
                  asChild
                >
                  <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}><Phone className="mr-2" /> Request a Project Consultation</motion.a>
                </Button>
              </Link>
            </div>
          </div>
