              ...
              <motion.a
                className={`text-sm font-medium ${
                  index === items.length - 1
                    ? 'text-yellow-400 cursor-default' // Changed from cyan to yellow for solar theme
...
// --- DesertSolarInstallationPage Component ---
export default function DesertSolarInstallationPage() {
  ...
  // Sample project images for desert solar installation
  const projectImages = [
    'https://plus.unsplash.com/premium_photo-1679952890552-2a39f4b38708?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Solar panels in desert
    'https://images.unsplash.com/photo-1502637098811-fa9526d2b659?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Solar farm aerial
    'https://images.unsplash.com/photo-1509391366360-2e959784a276?q=80&w=2072&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Another solar image
    'https://plus.unsplash.com/premium_photo-1679952890596-e7c9da6a4655?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'  // Desert landscape with solar
  ];
  ...
  const themeClasses = mounted && isDarkMode
    ? 'bg-gradient-to-br from-gray-900 via-stone-800 to-gray-900 text-white' // Dark desert theme
    : 'bg-gradient-to-br from-yellow-50 via-amber-100 to-orange-50 text-gray-900'; // Light desert theme

  const cardClasses = mounted && isDarkMode
    ? 'bg-stone-800/40 border-amber-700/50 hover:bg-stone-800/60' // Dark solar card
    : 'bg-white/40 border-yellow-200/50 hover:bg-white/60'; // Light solar card

  const glowClasses = mounted && isDarkMode
    ? 'shadow-[0_0_30px_rgba(255,200,0,0.3),_0_0_60px_rgba(255,220,0,0.2)]' // Yellow/gold glow for solar
    : 'shadow-[0_0_20px_rgba(255,200,0,0.1),_0_0_40px_rgba(255,220,0,0.08)]';

  const titleGradient = mounted && isDarkMode
    ? 'from-yellow-300 via-amber-400 to-orange-500' // Dark solar title
    : 'from-yellow-600 via-amber-700 to-orange-800'; // Light solar title
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className={`absolute -top-40 -right-40 w-80 h-80 rounded-full ${
            mounted && isDarkMode ? 'bg-gradient-to-br from-yellow-500/10 to-amber-500/5' : 'bg-gradient-to-br from-yellow-500/5 to-amber-500/3'
          } blur-3xl`}
        />
        <motion.div
          animate={{
          ...
          className={`absolute -bottom-40 -left-40 w-96 h-96 rounded-full ${
            mounted && isDarkMode ? 'bg-gradient-to-br from-orange-500/10 to-yellow-500/5' : 'bg-gradient-to-br from-orange-500/5 to-yellow-500/3'
          } blur-3xl`}
        />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-6 py-12 pt-28">
        ...
        >
          <Breadcrumb items={[
            ...
            { label: 'Desert Solar Installation', href: '/projects/desert_solar_installation' },
          ]} />
        </motion.div>
                ...
                {projectImages.map((_, index) => (
                  <motion.button
                    ...
                    className={`w-3 h-3 rounded-full transition-all ${
                      currentImage === index ? 'bg-yellow-400 scale-125' : 'bg-white/50'
                    }`}
        ...
        >
          <div className="grid md:grid-cols-2 gap-8">
            <motion.div
              ...
              whileHover={{ scale: 1.01, boxShadow: mounted && isDarkMode ? "0 0 40px rgba(255,200,0,0.4)" : "0 0 30px rgba(255,200,0,0.2)" }}
            >
              ...
              <div className="space-y-4">
                <div className={`flex items-center space-x-3 ${mounted && isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>
                  ...
                  <span className="text-lg">Jodhpur, Rajasthan, India</span>
                </div>
                <div className={`flex items-center space-x-3 ${mounted && isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>
                  <Users className="w-5 h-5 text-yellow-400" />
                  <span className="text-lg">Solar Dynamics Ltd</span>
                </div>
            ...
            <motion.div
              className={`p-8 rounded-3xl border transition-all duration-300 ${cardClasses} ${glowClasses}`}
              whileHover={{ scale: 1.01, boxShadow: mounted && isDarkMode ? "0 0 40px rgba(255,220,0,0.4)" : "0 0 30px rgba(255,220,0,0.2)" }}
            >
              ...
              <div className="grid grid-cols-2 gap-6">
                <motion.div className="text-center" initial={{ scale: 0.8 }} animate={{ scale: 1 }} transition={{ delay: 0.9, type: "spring" }}>
                  ...
                  <div className={`text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r ${mounted && isDarkMode ? 'from-yellow-300 to-amber-400' : 'from-yellow-600 to-amber-700'}`}>100</div>
                ...
                <motion.div className="text-center" initial={{ scale: 0.8 }} animate={{ scale: 1 }} transition={{ delay: 1.0, type: "spring" }}>
                  ...
                  <div className={`text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r ${mounted && isDarkMode ? 'from-orange-300 to-red-400' : 'from-orange-600 to-red-700'}`}>12</div>
                ...
                <motion.div className="text-center" initial={{ scale: 0.8 }} animate={{ scale: 1 }} transition={{ delay: 1.1, type: "spring" }}>
                  <div className="flex items-center justify-center mb-2">
                    <Lightbulb className="w-7 h-7 text-white-400" />
                  </div>
                  <div className={`text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r ${mounted && isDarkMode ? 'from-yellow-200 to-yellow-300' : 'from-yellow-500 to-yellow-600'}`}>50MW</div>
                  <div className={`text-sm ${mounted && isDarkMode ? 'opacity-70' : 'opacity-80'}`}>Output Capacity</div>
                </motion.div>
                <motion.div className="text-center" initial={{ scale: 0.8 }} animate={{ scale: 1 }} transition={{ delay: 1.2, type: "spring" }}>
                  ...
                  <div className={`text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r ${mounted && isDarkMode ? 'from-blue-300 to-cyan-400' : 'from-blue-600 to-cyan-700'}`}>10M+</div>
                  <div className={`text-sm ${mounted && isDarkMode ? 'opacity-70' : 'opacity-80'}`}>Litres Water Saved Annually</div>
                </motion.div>
              </div>
            </motion.div>
          </div>
        ...
        >
          <div className={`p-8 rounded-3xl border transition-all duration-300 ${cardClasses} ${glowClasses}`}>
            ...
            <div className="relative h-96 rounded-2xl overflow-hidden">
              <img
                src="https://images.unsplash.com/photo-1547235001-d703406d3f17?q=80&w=2074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" // Placeholder for "Before" - desert landscape
              ...
              />
              <img
                src="https://images.unsplash.com/photo-1502637098811-fa9526d2b659?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" // Placeholder for "After" - solar farm
        ...
        >
          <div className={`p-8 rounded-3xl text-center border transition-all duration-300 ${cardClasses} ${glowClasses}`}>
            <div className="mb-6">
              <motion.div
                className="w-16 h-16 mx-auto rounded-full bg-gradient-to-r from-yellow-400 to-orange-500 flex items-center justify-center mb-4 text-white"
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
              ...
              <h4 className={`text-xl font-semibold ${mounted && isDarkMode ? 'text-white' : 'text-gray-900'}`}>Sunil Mehta</h4>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className={`text-lg mb-8 max-w-2xl mx-auto ${mounted && isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>
              Explore more of our impactful renewable energy projects or delve deeper into our offerings.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
              <Link href="/projects/wind-farm-expansion" passHref legacyBehavior>
                <Button className={`w-full py-3 px-6 rounded-xl text-lg font-semibold transition-all duration-300 transform ${mounted && isDarkMode ? 'bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white shadow-lg' : 'bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white shadow-lg'}`}
                  asChild
                >
                  <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}><Zap className="mr-2" /> View Our Wind Farm Project</motion.a>
                </Button>
              </Link>
              <Link href="/projects/rooftop-solar-solutions" passHref legacyBehavior>
                <Button className={`w-full py-3 px-6 rounded-xl text-lg font-semibold transition-all duration-300 transform ${mounted && isDarkMode ? 'bg-gradient-to-r from-green-600 to-lime-600 hover:from-green-700 hover:to-lime-700 text-white shadow-lg' : 'bg-gradient-to-r from-green-500 to-lime-500 hover:from-green-600 hover:to-lime-600 text-white shadow-lg'}`}
                  asChild
                >
                  <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}><Sun className="mr-2" /> Explore Our Rooftop Solar Solutions</motion.a>
                </Button>
              </Link>
              <Link href="/services/renewable-energy-solutions" passHref legacyBehavior>
                <Button className={`w-full py-3 px-6 rounded-xl text-lg font-semibold transition-all duration-300 transform ${mounted && isDarkMode ? 'bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white shadow-lg' : 'bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white shadow-lg'}`}
                  asChild
                >
                  <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}><Lightbulb className="mr-2" /> Learn About Our Renewable Energy Services</motion.a>
                </Button>
              </Link>
              <Link href="/contact" passHref legacyBehavior>
                <Button className={`w-full py-3 px-6 rounded-xl text-lg font-semibold transition-all duration-300 transform ${mounted && isDarkMode ? 'bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-700 hover:to-orange-700 text-white shadow-lg' : 'bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white shadow-lg'}`}
                  asChild
                >
                  <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}><Phone className="mr-2" /> Get a Solar Project Quote</motion.a>
                </Button>
              </Link>
            </div>
          </div>
