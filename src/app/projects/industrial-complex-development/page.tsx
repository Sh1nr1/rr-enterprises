...
// --- IndustrialProjectShowcase Component ---
// Renamed the function to match the typical page component naming convention for clarity,
// although the original name would also work if exported correctly.
export default function IndustrialComplexDevelopmentPage() {
  ...
  // Sample project images for industrial complex
  const projectImages = [
    'https://images.unsplash.com/photo-1600313419152-c66124a3b727?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    ...
    'https://images.unsplash.com/photo-1693421462775-fdd57b7d14d7?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    'https://images.unsplash.com/photo-1689237286061-5f070c00b96a?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
  ];
  ...
  const titleGradient = mounted && isDarkMode
    ...
    : 'from-orange-600 via-yellow-700 to-red-800';
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className={`absolute -bottom-40 -left-40 w-96 h-96 rounded-full ${
            mounted && isDarkMode ? 'bg-gradient-to-br from-red-500/10 to-amber-500/5' : 'bg-gradient-to-br from-red-500/5 to-amber-500/3'
          } blur-3xl`}
        />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-6 py-12 pt-28">
        ...
        >
          <Breadcrumb items={[
            ...
            { label: 'Ahmedabad Industrial Complex', href: '/projects/ahmedabad_industrial_complex' },
          ]} />
        </motion.div>
        ...
        >
          ...
          >
            A state-of-the-art industrial infrastructure project for Gujarat Industries Ltd, designed for efficiency and sustainability.
          </motion.p>
        </motion.header>
            ...
            <div className="relative h-96 md:h-[500px] rounded-2xl overflow-hidden">
              <AnimatePresence initial={false} mode="wait">
                <motion.img
                  ...
                  alt={`Industrial Project ${currentImage + 1}`}
                ...
                {projectImages.map((_, index) => (
                  <motion.button
                    ...
                    className={`w-3 h-3 rounded-full transition-all ${
                      currentImage === index ? 'bg-orange-400 scale-125' : 'bg-white/50'
                    }`}
        ...
        >
          <div className="grid md:grid-cols-2 gap-8">
            <motion.div
              ...
              whileHover={{ scale: 1.01, boxShadow: mounted && isDarkMode ? "0 0 40px rgba(255,165,0,0.4)" : "0 0 30px rgba(255,165,0,0.2)" }}
            >
              ...
              <div className="space-y-4">
                ...
                <div className={`flex items-center space-x-3 ${mounted && isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>
                  ...
                  <span className="text-lg">Gujarat Industries Ltd</span>
                </div>
                <p className={`text-lg leading-relaxed ${mounted && isDarkMode ? 'opacity-80' : 'opacity-90'}`}>
                  Development of a sprawling **50-acre industrial complex** featuring state-of-the-art manufacturing units,
                  warehousing facilities, and an integrated logistics hub. The project emphasizes **sustainable design**,
                  incorporating rainwater harvesting and waste management systems for a greener industrial footprint.
                </p>
              </div>
            </motion.div>
            ...
            <motion.div
              className={`p-8 rounded-3xl border transition-all duration-300 ${cardClasses} ${glowClasses}`}
              whileHover={{ scale: 1.01, boxShadow: mounted && isDarkMode ? "0 0 40px rgba(255,140,0,0.4)" : "0 0 30px rgba(255,140,0,0.2)" }}
            >
              ...
              <div className="grid grid-cols-2 gap-6">
                <motion.div className="text-center" initial={{ scale: 0.8 }} animate={{ scale: 1 }} transition={{ delay: 0.9, type: "spring" }}>
                  ...
                  <div className={`text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r ${mounted && isDarkMode ? 'from-orange-300 to-yellow-400' : 'from-orange-600 to-yellow-700'}`}>50</div>
                ...
                <motion.div className="text-center" initial={{ scale: 0.8 }} animate={{ scale: 1 }} transition={{ delay: 1.0, type: "spring" }}>
                  ...
                  <div className={`text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r ${mounted && isDarkMode ? 'from-red-300 to-orange-400' : 'from-red-600 to-orange-700'}`}>18</div>
                ...
                <motion.div className="text-center" initial={{ scale: 0.8 }} animate={{ scale: 1 }} transition={{ delay: 1.1, type: "spring" }}>
                  ...
                  <div className={`text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r ${mounted && isDarkMode ? 'from-gray-300 to-slate-400' : 'from-gray-600 to-slate-700'}`}>200+</div>
                ...
                <motion.div className="text-center" initial={{ scale: 0.8 }} animate={{ scale: 1 }} transition={{ delay: 1.2, type: "spring" }}>
                  ...
                  <div className={`text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r ${mounted && isDarkMode ? 'from-lime-300 to-green-400' : 'from-lime-600 to-green-700'}`}>5MW</div>
                  <div className={`text-sm ${mounted && isDarkMode ? 'opacity-70' : 'opacity-80'}`}>Power Grid Integration</div>
                </motion.div>
              </div>
            </motion.div>
          </div>
        ...
        >
          <div className={`p-8 rounded-3xl border transition-all duration-300 ${cardClasses} ${glowClasses}`}>
            ...
            <div className="relative h-96 rounded-2xl overflow-hidden">
              <img
                src="https://images.unsplash.com/photo-1685533275529-db4ca68bbd01?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" // Placeholder for "Before"
              ...
              />
              <img
                src="https://images.unsplash.com/photo-1693421462775-fdd57b7d14d7?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" // Placeholder for "After"
        ...
        >
          <div className={`p-8 rounded-3xl text-center border transition-all duration-300 ${cardClasses} ${glowClasses}`}>
            <div className="mb-6">
              <motion.div
                className="w-16 h-16 mx-auto rounded-full bg-gradient-to-r from-orange-400 to-red-500 flex items-center justify-center mb-4 text-white"
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
              ...
              <h4 className={`text-xl font-semibold ${mounted && isDarkMode ? 'text-white' : 'text-gray-900'}`}>Ankit Kadam</h4>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className={`text-lg mb-8 max-w-2xl mx-auto ${mounted && isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>
              Explore more of our impactful industrial projects or delve deeper into our offerings.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
              <Link href="/projects/another-industrial-project" passHref legacyBehavior>
                <Button className={`w-full py-3 px-6 rounded-xl text-lg font-semibold transition-all duration-300 transform ${mounted && isDarkMode ? 'bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white shadow-lg' : 'bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white shadow-lg'}`}
                  asChild
                >
                  <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}><Factory className="mr-2" /> View Our Logistics Hub Project</motion.a>
                </Button>
              </Link>
              <Link href="/projects/power-plant-upgrade" passHref legacyBehavior>
                <Button className={`w-full py-3 px-6 rounded-xl text-lg font-semibold transition-all duration-300 transform ${mounted && isDarkMode ? 'bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 text-white shadow-lg' : 'bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white shadow-lg'}`}
                  asChild
                >
                  <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}><Zap className="mr-2" /> Explore Our Power Plant Upgrades</motion.a>
                </Button>
              </Link>
              <Link href="/services/epc-industrial" passHref legacyBehavior>
                <Button className={`w-full py-3 px-6 rounded-xl text-lg font-semibold transition-all duration-300 transform ${mounted && isDarkMode ? 'bg-gradient-to-r from-gray-600 to-blue-600 hover:from-gray-700 hover:to-blue-700 text-white shadow-lg' : 'bg-gradient-to-r from-gray-500 to-blue-500 hover:from-gray-600 hover:to-blue-600 text-white shadow-lg'}`}
                  asChild
                >
                  <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}><Briefcase className="mr-2" /> Learn About Our Industrial EPC Services</motion.a>
                </Button>
              </Link>
